/**
 * Lock01Icon — @gohighlevel/ghl-icons/24/outline
 * https://ghl-icons.msgsndr.net/
 */
export function Lock01Icon({ size = 24, className = '', color = 'currentColor', strokeWidth = 2, ...props }) {
  return (
    <svg
